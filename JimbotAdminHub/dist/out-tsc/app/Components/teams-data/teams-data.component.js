...
var TeamsDataComponent = /** @class */ (function () {
    function TeamsDataComponent(teamService, fb, errorMessage, Error, dataObjects, cd, modalService) {
    ...
    TeamsDataComponent.prototype.ngOnInit = function () {
        this.navbar.setNavFlag(this.navFlag);
        this.getAllTeams();
    };
    TeamsDataComponent.prototype.openModal = function (id) {
        var modal = document.getElementById(id);
        modal.style.display = 'block';
    };
    TeamsDataComponent.prototype.closeModal = function (id) {
        var modal = document.getElementById(id);
        modal.style.display = 'none';
    };
    TeamsDataComponent.prototype.handleFiles = function (event) {
    ...
    TeamsDataComponent.prototype.loadHandler = function (event) {
    ...
    TeamsDataComponent.prototype.errorHandler = function (event) {
        if (event.target.error.name == "NotReadableError") {
            alert('Cannot read File');
        }
    };
    TeamsDataComponent.prototype.setAvatar = function (avatar) {
        var _this = this;
        var reader = new FileReader();
    ...
    TeamsDataComponent.prototype.getAllTeams = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.initTeamArray = [];
                        this.editTeamArray = [];
                        return [4 /*yield*/, this.teamService.getTeamData()];
                    case 1:
                        jData = _a.sent();
    ...
    TeamsDataComponent.prototype.loopTeamDB = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.teamDBList.forEach(function (team) {
                    //console.log(person)
                    _this.teamService.getEditTeam(team.teamID)
                        .subscribe(function (initialTeam) { return _this.sortTeam(initialTeam); }, function (error) { return console.log(error); });
                });
                return [2 /*return*/];
            });
        });
    };
    TeamsDataComponent.prototype.sortTeam = function (initialTeam) {
    ...
    TeamsDataComponent.prototype.convertToCSV = function (jsonData) {
    ...
    TeamsDataComponent.prototype.CSVDownload = function () {
    ...
    TeamsDataComponent.prototype.getEditTeam = function (teamEdit, teamID) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log(this.editTeamArray);
                        _a = this;
                        return [4 /*yield*/, this.teamService.getEditTeam(teamID)];
                    case 1:
                        _a.teamData = _b.sent();
                        return [2 /*return*/];
                }
    ...
    return TeamsDataComponent;
}());
exports.TeamsDataComponent = TeamsDataComponent;
//# sourceMappingURL=teams-data.component.js.map